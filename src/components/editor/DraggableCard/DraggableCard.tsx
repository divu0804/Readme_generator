      ...
      <Group position="apart" style={{ marginBottom: 5, marginTop: theme.spacing.sm }}>
        ...
        <Box>
          <Group>
            ...
            <ActionIcon onClick={handleUp} color="blue" variant="light" aria-label="move block up">
              <FiArrowUp aria-hidden />
            </ActionIcon>
            <ActionIcon onClick={handleReset} color="yellow" variant="light" aria-label="reset block">
